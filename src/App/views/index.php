...
// echo __DIR__;
// My Debug
if ($this instanceof \Framework\TemplateEngine) {
  echo "Yes, index.php is running within the context of TemplateEngine. <br>";
} else {
  echo "No, index.php is not running within the context of TemplateEngine. <br>";
}
